...
WORKDIR $HOME
RUN wget --quiet RUN wget --quiet https://files.minecraftforge.net/maven/net/minecraftforge/forge/1.13.2-25.0.59/forge-1.13.2-25.0.59-installer.jar
